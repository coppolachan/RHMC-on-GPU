...
class AlgRemez
{
 ...
 public:
  ...
  double generateApprox(int num_degree, int den_degree, unsigned long power_num1, unsigned long power_den1, 
                        int a_len, double* a_param, int* a_pow);
  double generateApprox(int num_degree, int den_degree, unsigned long power_num1, unsigned long power_den1);
  double generateApprox(int degree, unsigned long power_num1, unsigned long power_den1);
